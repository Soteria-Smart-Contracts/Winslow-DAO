...
contract SaleFactoryV2{
    ...
    function CreateNewSale(uint256 SaleID, uint256 CLDtoSell) external OnlyDAO returns(address _NewSaleAddress){
        ...
        require(TreasuryCLDBalance >= CLDtoSell && CLDtoSell <= ((TreasuryCLDBalance * MaximumSalePercentage) / 10000)); //TODO: Ensure the math here is right
    ...
    function ChangeFoundationFee(uint256 NewFee) 
