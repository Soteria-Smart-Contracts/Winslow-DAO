...
contract Winslow_Core_V1 {
    ...
    uint256 public VoteLength = 172800; //Default two days for an efficient DAO, can be changed by proposals in case quorums are not being met
    ...
    constructor(){
        ...
        SubmitSimpleProposal("TODO: Make a community agreed first memo", address(0), 0, SimpleProposalTypes(0), VotingLength, RequestedEther, RequestedAssetAmount, RequestedAssetID);
    }
