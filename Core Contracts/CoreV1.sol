...
contract Winslow_Core_V1 {
    ...
    function InitializeSimpleProposal(string memory Memo, address AddressSlot, uint256 UintSlot, SimpleProposalTypes SimpleType, uint256 RequestedEther, uint256 RequestedAssetAmount, uint8 RequestedAssetID) internal returns(uint256 Identifier){
        ...
        uint256 VotingInstanceID = Winslow_Voting_V1(VotingContract).InitializeVoteInstance(NewIdentifier, false, 0);
...
contract Winslow_Voting_V1 {
    ...
    function GetVotingInstance(uint256 _VoteInstance) public view returns(uint256 ProposalID, uint256 VoteStarts, uint256 VoteEnds, VoteStatus Status, address[] memory Voters, uint256 TotalCLDVoted, uint8 MaxMulti, uint256 YEAvotes, uint256 NAYvotes, uint256 TotalIncentive, uint256 IncentivePerVote, uint256 CLDtoIncentive, uint256 CLDToBurn, uint256 CLDToExecutioner){
        return(VotingInstances[_VoteInstance].ProposalID, VotingInstances[_VoteInstance].VoteStarts, VotingInstances[_VoteInstance].VoteEnds, VotingInstances[_VoteInstance].Status, VotingInstances[_VoteInstance].Voters, VotingInstances[_VoteInstance].TotalCLDVoted, VotingInstances[_VoteInstance].MaxMulti, VotingInstances[_VoteInstance].YEAvotes, VotingInstances[_VoteInstance].NAYvotes, VotingInstances[_VoteInstance].TotalIncentive, VotingInstances[_VoteInstance].IncentivePerVote, VotingInstances[_VoteInstance].CLDtoIncentive, VotingInstances[_VoteInstance].CLDToBurn, VotingInstances[_VoteInstance].CLDToExecutioner);
    }
