...
contract Winslow_Voting_V1 {
    ...
    struct VoteInstance {
        ...
        uint256 Voters;    //Total Number of users that have voted
    ...
    //OnlyDAO functions
        ...
        //Vote Setup
    function InitializeVoteInstance(address Proposer, uint256 ProposalID, uint256 Time, bool Multi) external OnlyDAO returns(uint256 VoteInstanceID){

        uint256 NewInstanceID = MRInstance++;
        uint256 PublicVotingStart = 43200 
...
//  TODO: Set up Core to be able to switch itself to another core withought changing the voting or treasury
    ...
    receive() external payable{
        ...
        payable(CoreV1(DAO).Treasury()).transfer(address(this).balance);
    }
