...
contract VotingSystemV1 {
    ...
    function CastVote(uint256 amount, uint256 proposalId, Vote VoteChoice) external {
        ...
        require(block.timestamp <= VotingInstances[proposalId].VoteEnds && block.timestamp <= VotingInstances[proposalId].VoteEnds, "VotingSystemV1.CastVote: This instance is not currently in voting");
