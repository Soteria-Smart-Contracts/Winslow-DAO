...
contract VotingSystemV1 {
    ...
    event TokensReturned(address Voter, uint256 TotalSent, )
    ...
    function ReturnTokens(uint256 VotingInstance) external { //For returning your tokens for a specific instance after voting, with the incentive payout
        ...
        //emit TokensReturned(VoterInfo[VotingInstance][msg.sender].VotesLocked, (TotalToReturn - VoterInfo[VotingInstance][msg.sender].VotesLocked));
    }
