...
contract ErosProposal{
    ...
    function Execute() external OnlyDAO returns(bool success){
        ...
        if((TokenAddress != 0x0000000000000000000000000000000000000000)(ERC20(TokenAddress).balanceOf(address(this)) < 0) && (TokenAddress != 0x0000000000000000000000000000000000000000)){
